...
## Status: Phase 11 abgeschlossen (08.07.2026)
...
**Phase 12 – Benachrichtigungen & Einladungen:** Browser-Push-Benachrichtigungen (über die Notification-API hinaus, die Phase 9 clientseitig für Erwähnungen nutzt – jetzt echte Push, ggf. Service Worker) und Invite-Links mit Ablaufdatum/Nutzungslimit (`Invite`-Modell aus CLAUDE.md §5; ersetzt den offenen „Beitritt per Server-ID"-Endpunkt aus Phase 3, siehe ROADMAP).
